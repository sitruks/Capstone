...
Let’s now turn to the regular season game statistics. We are interested in knowing how certain statistics correlate with winning vs losing.
...
cvfit <- cv.glmnet(preds,label,family="binomial", type.measure = "class")
plot(cvfit)
...
optCutOff <- optimalCutoff(data_test$team1win, pred_prob[2])[1] #0.4828061
